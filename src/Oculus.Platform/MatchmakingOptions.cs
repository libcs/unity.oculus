namespace Oculus.Platform
{
    ...
    public class MatchmakingOptions
    {
        ...
        ~MatchmakingOptions() { CAPI.ovr_MatchmakingOptions_Destroy(Handle); }
        ...
        public void AddEnqueueAdditionalUser(ulong userID) => CAPI.ovr_MatchmakingOptions_AddEnqueueAdditionalUser(Handle, userID);
        ...
        public static explicit operator IntPtr(MatchmakingOptions options) => options != null ? options.Handle : IntPtr.Zero;
    }
}

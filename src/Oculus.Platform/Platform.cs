...
namespace Oculus.Platform
{
    ...
    public sealed class Core
    {
        ...
        public static bool IsInitialized() => IsPlatformInitialized;
        ...
        internal static void ForceInitialized() => IsPlatformInitialized = true;

        static string getAppID(string appId = null)
        {
            var configAppID = GetAppIDFromConfig();
        ...
        static string GetAppIDFromConfig() => UnityEngine.Application.platform == RuntimePlatform.Android ? PlatformSettings.MobileAppID : PlatformSettings.AppID;
    }

    public static class ApplicationLifecycle
    {
        public static Models.LaunchDetails GetLaunchDetails() => new Models.LaunchDetails(CAPI.ovr_ApplicationLifecycle_GetLaunchDetails());
    }

    public static partial class Rooms
    {
        public static Request<Models.Room> UpdateDataStore(ulong roomID, Dictionary<string, string> data)
        {
            if (Core.IsInitialized())
            {
                var kvps = new CAPI.ovrKeyValuePair[data.Count];
                var i = 0;
        ...
        public static void SetRoomInviteNotificationCallback(Message<string>.Callback callback) => SetRoomInviteAcceptedNotificationCallback(callback);
    }
    ...
    public static partial class Matchmaking
    {
        public class CustomQuery
        {
            ...
            public IntPtr ToUnmanaged()
            {
                ...
                var res = Marshal.AllocHGlobal(Marshal.SizeOf(customQueryUnmanaged));
        ...
        public static Request<Models.MatchmakingStats> GetStats(string pool, uint maxLevel, MatchmakingStatApproach approach = MatchmakingStatApproach.Trailing) => Core.IsInitialized() ? new Request<Models.MatchmakingStats>(CAPI.ovr_Matchmaking_GetStats(pool, maxLevel, approach)) : null;
    }
    ...
    public static partial class Net
    {
        public static Packet ReadPacket()
        {
            ...
            return packetHandle == IntPtr.Zero ? null : new Packet(packetHandle);
        }

        public static bool SendPacket(ulong userID, byte[] bytes, SendPolicy policy) => Core.IsInitialized() ? CAPI.ovr_Net_SendPacket(userID, (UIntPtr)bytes.Length, bytes, policy) : false;
        ...
        public static bool IsConnected(ulong userID) => Core.IsInitialized() && CAPI.ovr_Net_IsConnected(userID);

        public static bool SendPacketToCurrentRoom(byte[] bytes, SendPolicy policy) => Core.IsInitialized() ? CAPI.ovr_Net_SendPacketToCurrentRoom((UIntPtr)bytes.Length, bytes, policy) : false;

        public static bool AcceptForCurrentRoom() => Core.IsInitialized() ? CAPI.ovr_Net_AcceptForCurrentRoom() : false;
        ...
        public static Request<Models.PingResult> Ping(ulong userID) => Core.IsInitialized() ? new Request<Models.PingResult>(CAPI.ovr_Net_Ping(userID)) : null;
    }

    public static partial class Leaderboards
    {
        public static Request<Models.LeaderboardEntryList> GetNextEntries(Models.LeaderboardEntryList list) => Core.IsInitialized()
                ? new Request<Models.LeaderboardEntryList>(CAPI.ovr_HTTP_GetWithMessageType(list.NextUrl, (int)Message.MessageType.Leaderboard_GetNextEntries))
                : null;

        public static Request<Models.LeaderboardEntryList> GetPreviousEntries(Models.LeaderboardEntryList list) => Core.IsInitialized()
                ? new Request<Models.LeaderboardEntryList>(CAPI.ovr_HTTP_GetWithMessageType(list.PreviousUrl, (int)Message.MessageType.Leaderboard_GetPreviousEntries))
                : null;
    }
    ...
    public static partial class Voip
    {
        ...
        public static VoipMuteState GetSystemVoipMicrophoneMuted() => Core.IsInitialized() ? CAPI.ovr_Voip_GetSystemVoipMicrophoneMuted() : VoipMuteState.Unknown;

        public static SystemVoipStatus GetSystemVoipStatus() => Core.IsInitialized() ? CAPI.ovr_Voip_GetSystemVoipStatus() : SystemVoipStatus.Unknown;

        public static VoipDtxState GetIsConnectionUsingDtx(ulong peerID) => Core.IsInitialized() ? CAPI.ovr_Voip_GetIsConnectionUsingDtx(peerID) : VoipDtxState.Unknown;

        public static VoipBitrate GetLocalBitrate(ulong peerID) => Core.IsInitialized() ? CAPI.ovr_Voip_GetLocalBitrate(peerID) : VoipBitrate.Unknown;

        public static VoipBitrate GetRemoteBitrate(ulong peerID) => Core.IsInitialized() ? CAPI.ovr_Voip_GetRemoteBitrate(peerID) : VoipBitrate.Unknown;
    ...
    public static partial class Achievements
    {
        ...
        ///
        public static Request<Models.AchievementUpdate> AddCount(string name, ulong count) => Core.IsInitialized() ? new Request<Models.AchievementUpdate>(CAPI.ovr_Achievements_AddCount(name, count)) : null;
        ...
        ///
        public static Request<Models.AchievementUpdate> AddFields(string name, string fields) => Core.IsInitialized() ? new Request<Models.AchievementUpdate>(CAPI.ovr_Achievements_AddFields(name, fields)) : null;

        /// Request all achievement definitions for the app.
        ///
        public static Request<Models.AchievementDefinitionList> GetAllDefinitions() => Core.IsInitialized() ? new Request<Models.AchievementDefinitionList>(CAPI.ovr_Achievements_GetAllDefinitions()) : null;

        /// Request the progress for the user on all achievements in the app.
        ///
        public static Request<Models.AchievementProgressList> GetAllProgress() => Core.IsInitialized() ? new Request<Models.AchievementProgressList>(CAPI.ovr_Achievements_GetAllProgress()) : null;

        /// Request the achievement definitions that match the specified names.
        ///
        public static Request<Models.AchievementDefinitionList> GetDefinitionsByName(string[] names) => Core.IsInitialized()
                ? new Request<Models.AchievementDefinitionList>(CAPI.ovr_Achievements_GetDefinitionsByName(names, (names != null ? names.Length : 0)))
                : null;

        /// Request the user's progress on the specified achievements.
        ///
        public static Request<Models.AchievementProgressList> GetProgressByName(string[] names) => Core.IsInitialized()
                ? new Request<Models.AchievementProgressList>(CAPI.ovr_Achievements_GetProgressByName(names, (names != null ? names.Length : 0)))
                : null;

        /// Unlock the achievement with the given name. This can be of any achievement
        /// type.
        ///
        public static Request<Models.AchievementUpdate> Unlock(string name) => Core.IsInitialized() ? new Request<Models.AchievementUpdate>(CAPI.ovr_Achievements_Unlock(name)) : null;
    }
    ...
    public static partial class Application
    {
        ...
        ///
        public static Request<Models.ApplicationVersion> GetVersion() => Core.IsInitialized() ? new Request<Models.ApplicationVersion>(CAPI.ovr_Application_GetVersion()) : null;
        ...
        ///
        public static Request<string> LaunchOtherApp(ulong appID, ApplicationOptions deeplink_options = null) => Core.IsInitialized() ? new Request<string>(CAPI.ovr_Application_LaunchOtherApp(appID, (IntPtr)deeplink_options)) : null;
    }
    ...
    public static partial class AssetFile
    {
        ...
        ///
        public static Request<Models.AssetFileDeleteResult> Delete(ulong assetFileID) => Core.IsInitialized() ? new Request<Models.AssetFileDeleteResult>(CAPI.ovr_AssetFile_Delete(assetFileID)) : null;
        ...
        ///
        public static Request<Models.AssetFileDeleteResult> DeleteById(ulong assetFileID) => Core.IsInitialized() ? new Request<Models.AssetFileDeleteResult>(CAPI.ovr_AssetFile_DeleteById(assetFileID)) : null;
        ...
        ///
        public static Request<Models.AssetFileDeleteResult> DeleteByName(string assetFileName) => Core.IsInitialized() ? new Request<Models.AssetFileDeleteResult>(CAPI.ovr_AssetFile_DeleteByName(assetFileName)) : null;

        /// DEPRECATED. Use AssetFile.DownloadById()
        ///
        public static Request<Models.AssetFileDownloadResult> Download(ulong assetFileID) => Core.IsInitialized() ? new Request<Models.AssetFileDownloadResult>(CAPI.ovr_AssetFile_Download(assetFileID)) : null;
        ...
        /// \param assetFileID The asset file ID
        ///
        public static Request<Models.AssetFileDownloadResult> DownloadById(ulong assetFileID) => Core.IsInitialized() ? new Request<Models.AssetFileDownloadResult>(CAPI.ovr_AssetFile_DownloadById(assetFileID)) : null;
        ...
        /// \param assetFileName The asset file name
        ///
        public static Request<Models.AssetFileDownloadResult> DownloadByName(string assetFileName) => Core.IsInitialized() ? new Request<Models.AssetFileDownloadResult>(CAPI.ovr_AssetFile_DownloadByName(assetFileName)) : null;

        /// DEPRECATED. Use AssetFile.DownloadCancelById()
        ///
        public static Request<Models.AssetFileDownloadCancelResult> DownloadCancel(ulong assetFileID) => Core.IsInitialized()
                ? new Request<Models.AssetFileDownloadCancelResult>(CAPI.ovr_AssetFile_DownloadCancel(assetFileID))
                : null;
        ...
        /// \param assetFileID The asset file ID
        ///
        public static Request<Models.AssetFileDownloadCancelResult> DownloadCancelById(ulong assetFileID) => Core.IsInitialized()
                ? new Request<Models.AssetFileDownloadCancelResult>(CAPI.ovr_AssetFile_DownloadCancelById(assetFileID))
                : null;
        ...
        /// \param assetFileName The asset file name
        ///
        public static Request<Models.AssetFileDownloadCancelResult> DownloadCancelByName(string assetFileName) => Core.IsInitialized()
                ? new Request<Models.AssetFileDownloadCancelResult>(CAPI.ovr_AssetFile_DownloadCancelByName(assetFileName))
                : null;

        /// Returns an array of objects with asset file names and their associated IDs,
        /// and and whether it's currently installed.
        ///
        public static Request<Models.AssetDetailsList> GetList() => Core.IsInitialized() ? new Request<Models.AssetDetailsList>(CAPI.ovr_AssetFile_GetList()) : null;

        /// DEPRECATED. Use AssetFile.StatusById()
        ///
        public static Request<Models.AssetDetails> Status(ulong assetFileID) => Core.IsInitialized() ? new Request<Models.AssetDetails>(CAPI.ovr_AssetFile_Status(assetFileID)) : null;

        /// Returns the details on a single asset: ID, file name, and whether it's
        /// currently installed
        /// \param assetFileID The asset file ID
        ///
        public static Request<Models.AssetDetails> StatusById(ulong assetFileID) => Core.IsInitialized() ? new Request<Models.AssetDetails>(CAPI.ovr_AssetFile_StatusById(assetFileID)) : null;

        /// Returns the details on a single asset: ID, file name, and whether it's
        /// currently installed
        /// \param assetFileName The asset file name
        ///
        public static Request<Models.AssetDetails> StatusByName(string assetFileName) => Core.IsInitialized() ? new Request<Models.AssetDetails>(CAPI.ovr_AssetFile_StatusByName(assetFileName)) : null;

        /// Sent to indicate download progress for asset files.
        ///
        public static void SetDownloadUpdateNotificationCallback(Message<Models.AssetFileDownloadUpdate>.Callback callback) => Callback.SetNotificationCallback(
    ...
    public static partial class CloudStorage
    {
        ...
        ///
        public static Request<Models.CloudStorageUpdateResponse> Delete(string bucket, string key) => Core.IsInitialized() ? new Request<Models.CloudStorageUpdateResponse>(CAPI.ovr_CloudStorage_Delete(bucket, key)) : null;
        ...
        /// \param key The name for this saved data.
        ///
        public static Request<Models.CloudStorageData> Load(string bucket, string key) => Core.IsInitialized() ? new Request<Models.CloudStorageData>(CAPI.ovr_CloudStorage_Load(bucket, key)) : null;

        /// Loads all the metadata for the saves in the specified bucket, including
        /// conflicts.
        /// \param bucket The name of the storage bucket.
        ///
        public static Request<Models.CloudStorageMetadataList> LoadBucketMetadata(string bucket) => Core.IsInitialized() ? new Request<Models.CloudStorageMetadataList>(CAPI.ovr_CloudStorage_LoadBucketMetadata(bucket)) : null;
        ...
        ///
        public static Request<Models.CloudStorageConflictMetadata> LoadConflictMetadata(string bucket, string key) => Core.IsInitialized()
                ? new Request<Models.CloudStorageConflictMetadata>(CAPI.ovr_CloudStorage_LoadConflictMetadata(bucket, key))
                : null;

        /// Loads the data specified by the storage handle.
        ///
        public static Request<Models.CloudStorageData> LoadHandle(string handle) => Core.IsInitialized() ? new Request<Models.CloudStorageData>(CAPI.ovr_CloudStorage_LoadHandle(handle)) : null;

        /// load the metadata for the specified key
        /// \param bucket The name of the storage bucket.
        /// \param key The name for this saved data.
        ///
        public static Request<Models.CloudStorageMetadata> LoadMetadata(string bucket, string key) => Core.IsInitialized() ? new Request<Models.CloudStorageMetadata>(CAPI.ovr_CloudStorage_LoadMetadata(bucket, key)) : null;
        ...
        ///
        public static Request<Models.CloudStorageUpdateResponse> ResolveKeepLocal(string bucket, string key, string remoteHandle) => Core.IsInitialized()
                ? new Request<Models.CloudStorageUpdateResponse>(CAPI.ovr_CloudStorage_ResolveKeepLocal(bucket, key, remoteHandle))
                : null;
        ...
        ///
        public static Request<Models.CloudStorageUpdateResponse> ResolveKeepRemote(string bucket, string key, string remoteHandle) => Core.IsInitialized()
                ? new Request<Models.CloudStorageUpdateResponse>(CAPI.ovr_CloudStorage_ResolveKeepRemote(bucket, key, remoteHandle))
                : null;
        ...
        ///
        public static Request<Models.CloudStorageUpdateResponse> Save(string bucket, string key, byte[] data, long counter, string extraData) => Core.IsInitialized()
                ? new Request<Models.CloudStorageUpdateResponse>(CAPI.ovr_CloudStorage_Save(bucket, key, data, (uint)(data != null ? data.Length : 0), counter, extraData))
                : null;
    }
    ...
    public static partial class Entitlements
    {
        ...
        ///
        public static Request IsUserEntitledToApplication() => Core.IsInitialized() ? new Request(CAPI.ovr_Entitlement_GetIsViewerEntitled()) : null;
    }
    ...
    public static partial class IAP
    {
        ...
        ///
        public static Request ConsumePurchase(string sku) => Core.IsInitialized() ? new Request(CAPI.ovr_IAP_ConsumePurchase(sku)) : null;

        /// Retrieve a list of IAP products that can be purchased.
        /// \param skus The SKUs of the products to retrieve.
        ///
        public static Request<Models.ProductList> GetProductsBySKU(string[] skus) => Core.IsInitialized()
                ? new Request<Models.ProductList>(CAPI.ovr_IAP_GetProductsBySKU(skus, skus != null ? skus.Length : 0))
                : null;
        ...
        ///
        public static Request<Models.PurchaseList> GetViewerPurchases() => Core.IsInitialized() ? new Request<Models.PurchaseList>(CAPI.ovr_IAP_GetViewerPurchases()) : null;
    ...
    public static partial class LanguagePack
    {
        ...
        ///
        public static Request<Models.AssetDetails> GetCurrent() => Core.IsInitialized() ? new Request<Models.AssetDetails>(CAPI.ovr_LanguagePack_GetCurrent()) : null;
        ...
        ///
        public static Request<Models.AssetFileDownloadResult> SetCurrent(string tag) => Core.IsInitialized() ? new Request<Models.AssetFileDownloadResult>(CAPI.ovr_LanguagePack_SetCurrent(tag)) : null;
    }
    ...
    public static partial class Leaderboards
    {
        ...
        ///
        public static Request<Models.LeaderboardEntryList> GetEntries(string leaderboardName, int limit, LeaderboardFilterType filter, LeaderboardStartAt startAt) => Core.IsInitialized()
                ? new Request<Models.LeaderboardEntryList>(CAPI.ovr_Leaderboard_GetEntries(leaderboardName, limit, filter, startAt))
                : null;
        ...
        ///
        public static Request<Models.LeaderboardEntryList> GetEntriesAfterRank(string leaderboardName, int limit, ulong afterRank) => Core.IsInitialized()
                ? new Request<Models.LeaderboardEntryList>(CAPI.ovr_Leaderboard_GetEntriesAfterRank(leaderboardName, limit, afterRank))
                : null;
        ...
        ///
        public static Request<bool> WriteEntry(string leaderboardName, long score, byte[] extraData = null, bool forceUpdate = false) => Core.IsInitialized()
                ? new Request<bool>(CAPI.ovr_Leaderboard_WriteEntry(leaderboardName, score, extraData, (uint)(extraData != null ? extraData.Length : 0), forceUpdate))
                : null;
    }
    ...
    public static partial class Livestreaming
    {
        ...
        ///
        public static Request<Models.LivestreamingStatus> GetStatus() => Core.IsInitialized() ? new Request<Models.LivestreamingStatus>(CAPI.ovr_Livestreaming_GetStatus()) : null;

        /// Pauses the livestreaming session if there is one. NOTE: this function is
        /// safe to call if no session is active.
        ///
        public static Request<Models.LivestreamingStatus> PauseStream() => Core.IsInitialized() ? new Request<Models.LivestreamingStatus>(CAPI.ovr_Livestreaming_PauseStream()) : null;

        /// Resumes the livestreaming session if there is one. NOTE: this function is
        /// safe to call if no session is active.
        ///
        public static Request<Models.LivestreamingStatus> ResumeStream() => Core.IsInitialized() ? new Request<Models.LivestreamingStatus>(CAPI.ovr_Livestreaming_ResumeStream()) : null;
        ...
        ///
        public static void SetStatusUpdateNotificationCallback(Message<Models.LivestreamingStatus>.Callback callback) => Callback.SetNotificationCallback(
    ...
    public static partial class Matchmaking
    {
        ...
        ///
        public static Request<Models.MatchmakingBrowseResult> Browse(string pool, CustomQuery customQueryData = null) => Core.IsInitialized()
                ? new Request<Models.MatchmakingBrowseResult>(CAPI.ovr_Matchmaking_Browse(pool, customQueryData != null ? customQueryData.ToUnmanaged() : IntPtr.Zero))
                : null;
        ...
        /// - \b 12072: Unknown pool: {pool_key}. You can configure matchmaking pools at https://dashboard.oculus.com/application/&lt;app_id&gt;/matchmaking
        ///
        public static Request<Models.MatchmakingBrowseResult> Browse2(string pool, MatchmakingOptions matchmakingOptions = null) => Core.IsInitialized()
                ? new Request<Models.MatchmakingBrowseResult>(CAPI.ovr_Matchmaking_Browse2(pool, (IntPtr)matchmakingOptions))
                : null;
        ...
        ///
        public static Request Cancel(string pool, string requestHash) => Core.IsInitialized() ? new Request(CAPI.ovr_Matchmaking_Cancel(pool, requestHash)) : null;
        ...
        /// - \b 100: Invalid room_id: {room_id}. Either the ID is not a valid room or the user does not have permission to see or act on the room.
        ///
        public static Request Cancel() => Core.IsInitialized() ? new Request(CAPI.ovr_Matchmaking_Cancel2()) : null;
        ...
        ///
        public static Request<Models.MatchmakingEnqueueResultAndRoom> CreateAndEnqueueRoom(string pool, uint maxUsers, bool subscribeToUpdates = false, CustomQuery customQueryData = null) => Core.IsInitialized()
                ? new Request<Models.MatchmakingEnqueueResultAndRoom>(CAPI.ovr_Matchmaking_CreateAndEnqueueRoom(pool, maxUsers, subscribeToUpdates, customQueryData != null ? customQueryData.ToUnmanaged() : IntPtr.Zero))
                : null;
        ...
        /// - \b 12089: You have asked to enqueue {num_users} users together, but this must be less than the maximum number of users in a room, {max_users}.
        ///
        public static Request<Models.MatchmakingEnqueueResultAndRoom> CreateAndEnqueueRoom2(string pool, MatchmakingOptions matchmakingOptions = null) => Core.IsInitialized()
                ? new Request<Models.MatchmakingEnqueueResultAndRoom>(CAPI.ovr_Matchmaking_CreateAndEnqueueRoom2(pool, (IntPtr)matchmakingOptions))
                : null;
        ...
        ///
        public static Request<Models.Room> CreateRoom(string pool, uint maxUsers, bool subscribeToUpdates = false) => Core.IsInitialized() ? new Request<Models.Room>(CAPI.ovr_Matchmaking_CreateRoom(pool, maxUsers, subscribeToUpdates)) : null;
        ...
        /// \param matchmakingOptions Additional matchmaking configuration for this request. Optional.
        ///
        public static Request<Models.Room> CreateRoom2(string pool, MatchmakingOptions matchmakingOptions = null) => Core.IsInitialized() ? new Request<Models.Room>(CAPI.ovr_Matchmaking_CreateRoom2(pool, (IntPtr)matchmakingOptions)) : null;
        ...
        /// - \b 12072: Unknown pool: {pool_key}. You can configure matchmaking pools at https://dashboard.oculus.com/application/&lt;app_id&gt;/matchmaking
        ///
        public static Request<Models.MatchmakingEnqueueResult> Enqueue(string pool, CustomQuery customQueryData = null) => Core.IsInitialized()
                ? new Request<Models.MatchmakingEnqueueResult>(CAPI.ovr_Matchmaking_Enqueue(pool, customQueryData != null ? customQueryData.ToUnmanaged() : IntPtr.Zero))
                : null;
        ...
        /// - \b 12072: Unknown pool: {pool_key}. You can configure matchmaking pools at https://dashboard.oculus.com/application/&lt;app_id&gt;/matchmaking
        ///
        public static Request<Models.MatchmakingEnqueueResult> Enqueue2(string pool, MatchmakingOptions matchmakingOptions = null) => Core.IsInitialized()
                ? new Request<Models.MatchmakingEnqueueResult>(CAPI.ovr_Matchmaking_Enqueue2(pool, (IntPtr)matchmakingOptions))
                : null;
        ...
        /// - \b 12051: Pool '{pool_key}' is configured for Quickmatch mode. In Quickmatch mode, rooms are created on users' behalf when a match is found. Specify Advanced Quickmatch or Browse mode to use this feature.
        ///
        public static Request<Models.MatchmakingEnqueueResult> EnqueueRoom(ulong roomID, CustomQuery customQueryData = null) => Core.IsInitialized()
                ? new Request<Models.MatchmakingEnqueueResult>(CAPI.ovr_Matchmaking_EnqueueRoom(roomID, customQueryData != null ? customQueryData.ToUnmanaged() : IntPtr.Zero))
                : null;
        ...
        /// - \b 12051: Pool '{pool_key}' is configured for Quickmatch mode. In Quickmatch mode, rooms are created on users' behalf when a match is found. Specify Advanced Quickmatch or Browse mode to use this feature.
        ///
        public static Request<Models.MatchmakingEnqueueResult> EnqueueRoom2(ulong roomID, MatchmakingOptions matchmakingOptions = null) => Core.IsInitialized()
                ? new Request<Models.MatchmakingEnqueueResult>(CAPI.ovr_Matchmaking_EnqueueRoom2(roomID, (IntPtr)matchmakingOptions))
                : null;
        ...
        ///
        public static Request<Models.MatchmakingAdminSnapshot> GetAdminSnapshot() => Core.IsInitialized() ? new Request<Models.MatchmakingAdminSnapshot>(CAPI.ovr_Matchmaking_GetAdminSnapshot()) : null;
        ...
        /// \param subscribeToUpdates If true, sends a message with type MessageType.Notification_Room_RoomUpdate when room data changes, such as when users join or leave.
        ///
        public static Request<Models.Room> JoinRoom(ulong roomID, bool subscribeToUpdates = false) => Core.IsInitialized() ? new Request<Models.Room>(CAPI.ovr_Matchmaking_JoinRoom(roomID, subscribeToUpdates)) : null;
        ...
        ///
        public static Request StartMatch(ulong roomID) => Core.IsInitialized() ? new Request(CAPI.ovr_Matchmaking_StartMatch(roomID)) : null;
        ...
        /// room.
        ///
        public static void SetMatchFoundNotificationCallback(Message<Models.Room>.Callback callback) => Callback.SetNotificationCallback(Message.MessageType.Notification_Matchmaking_MatchFound, callback);
    }
    ...
    public static partial class Media
    {
        ...
        ///
        public static Request<Models.ShareMediaResult> ShareToFacebook(string postTextSuggestion, string filePath, MediaContentType contentType) => Core.IsInitialized()
                ? new Request<Models.ShareMediaResult>(CAPI.ovr_Media_ShareToFacebook(postTextSuggestion, filePath, contentType))
                : null;
    }
    ...
    public static partial class Net
    {
        ...
        ///
        public static void SetConnectionStateChangedCallback(Message<Models.NetworkingPeer>.Callback callback) => Callback.SetNotificationCallback(Message.MessageType.Notification_Networking_ConnectionStateChange, callback);
        ...
        ///
        public static void SetPeerConnectRequestCallback(Message<Models.NetworkingPeer>.Callback callback) => Callback.SetNotificationCallback(Message.MessageType.Notification_Networking_PeerConnectRequest, callback);

        /// Generated in response to Net.Ping(). Either contains ping time in
        /// microseconds or indicates that there was a timeout.
        ///
        public static void SetPingResultNotificationCallback(Message<Models.PingResult>.Callback callback) => Callback.SetNotificationCallback(Message.MessageType.Notification_Networking_PingResult, callback);
    }
    ...
    public static partial class Notifications
    {
        ...
        ///
        public static Request<Models.RoomInviteNotificationList> GetRoomInviteNotifications() => Core.IsInitialized() ? new Request<Models.RoomInviteNotificationList>(CAPI.ovr_Notification_GetRoomInvites()) : null;
        ...
        ///
        public static Request MarkAsRead(ulong notificationID) => Core.IsInitialized() ? new Request(CAPI.ovr_Notification_MarkAsRead(notificationID)) : null;
    }
    ...
    public static partial class Parties
    {
        ...
        ///
        public static Request<Models.Party> GetCurrent() => Core.IsInitialized() ? new Request<Models.Party>(CAPI.ovr_Party_GetCurrent()) : null;

        /// Indicates that party has been updated
        ///
        public static void SetPartyUpdateNotificationCallback(Message<Models.PartyUpdateNotification>.Callback callback) => Callback.SetNotificationCallback(Message.MessageType.Notification_Party_PartyUpdate, callback);
    }
    ...
    public static partial class Rooms
    {
        ...
        /// \param subscribeToUpdates If true, sends a message with type MessageType.Notification_Room_RoomUpdate when room data changes, such as when users join or leave.
        ///
        public static Request<Models.Room> CreateAndJoinPrivate(RoomJoinPolicy joinPolicy, uint maxUsers, bool subscribeToUpdates = false) => Core.IsInitialized()
                ? new Request<Models.Room>(CAPI.ovr_Room_CreateAndJoinPrivate(joinPolicy, maxUsers, subscribeToUpdates))
                : null;
        ...
        ///
        public static Request<Models.Room> CreateAndJoinPrivate2(RoomJoinPolicy joinPolicy, uint maxUsers, RoomOptions roomOptions) => Core.IsInitialized()
                ? new Request<Models.Room>(CAPI.ovr_Room_CreateAndJoinPrivate2(joinPolicy, maxUsers, (IntPtr)roomOptions))
                : null;

        /// Allows arbitrary rooms for the application to be loaded.
        /// \param roomID The room to load.
        ///
        public static Request<Models.Room> Get(ulong roomID) => Core.IsInitialized() ? new Request<Models.Room>(CAPI.ovr_Room_Get(roomID)) : null;
        ...
        ///
        public static Request<Models.Room> GetCurrent() => Core.IsInitialized() ? new Request<Models.Room>(CAPI.ovr_Room_GetCurrent()) : null;
        ...
        ///
        public static Request<Models.Room> GetCurrentForUser(ulong userID) => Core.IsInitialized() ? new Request<Models.Room>(CAPI.ovr_Room_GetCurrentForUser(userID)) : null;

        /// DEPRECATED. Use GetInvitableUsers2.
        ///
        public static Request<Models.UserList> GetInvitableUsers() => Core.IsInitialized() ? new Request<Models.UserList>(CAPI.ovr_Room_GetInvitableUsers()) : null;
        ...
        ///
        public static Request<Models.UserList> GetInvitableUsers2(RoomOptions roomOptions = null) => Core.IsInitialized() ? new Request<Models.UserList>(CAPI.ovr_Room_GetInvitableUsers2((IntPtr)roomOptions)) : null;

        /// Fetches the list of moderated rooms created for the application.
        ///
        public static Request<Models.RoomList> GetModeratedRooms() => Core.IsInitialized() ? new Request<Models.RoomList>(CAPI.ovr_Room_GetModeratedRooms()) : null;
        ...
        ///
        public static Request<Models.Room> InviteUser(ulong roomID, string inviteToken) => Core.IsInitialized() ? new Request<Models.Room>(CAPI.ovr_Room_InviteUser(roomID, inviteToken)) : null;
        ...
        ///
        public static Request<Models.Room> Join(ulong roomID, bool subscribeToUpdates = false) => Core.IsInitialized() ? new Request<Models.Room>(CAPI.ovr_Room_Join(roomID, subscribeToUpdates)) : null;
        ...
        /// - \b 100: This game isn't available. If it already started or was canceled, you can host a new game at any point.
        ///
        public static Request<Models.Room> Join2(ulong roomID, RoomOptions roomOptions) => Core.IsInitialized() ? new Request<Models.Room>(CAPI.ovr_Room_Join2(roomID, (IntPtr)roomOptions)) : null;
        ...
        ///
        public static Request<Models.Room> KickUser(ulong roomID, ulong userID, int kickDurationSeconds) => Core.IsInitialized() ? new Request<Models.Room>(CAPI.ovr_Room_KickUser(roomID, userID, kickDurationSeconds)) : null;
        ...
        /// build it yourself.
        ///
        public static Request LaunchInvitableUserFlow(ulong roomID) => Core.IsInitialized() ? new Request(CAPI.ovr_Room_LaunchInvitableUserFlow(roomID)) : null;

        /// Removes you from your current room. Returns the solo room you are now in if
        /// it succeeds
        /// \param roomID The room you're currently in.
        ///
        public static Request<Models.Room> Leave(ulong roomID) => Core.IsInitialized() ? new Request<Models.Room>(CAPI.ovr_Room_Leave(roomID)) : null;
        ...
        /// - \b 10: Room {room_id}: The user does not have permission to {cannot_action} because the user is not the owner of the room.
        ///
        public static Request<Models.Room> SetDescription(ulong roomID, string description) => Core.IsInitialized() ? new Request<Models.Room>(CAPI.ovr_Room_SetDescription(roomID, description)) : null;
        ...
        /// - \b 10: Room {room_id}: The user does not have permission to {cannot_action} because the user is not the owner of the room.
        ///
        public static Request<Models.Room> UpdateMembershipLockStatus(ulong roomID, RoomMembershipLockStatus membershipLockStatus) => Core.IsInitialized() ? new Request<Models.Room>(CAPI.ovr_Room_UpdateMembershipLockStatus(roomID, membershipLockStatus)) : null;
        ...
        ///
        public static Request UpdateOwner(ulong roomID, ulong userID) => Core.IsInitialized() ? new Request(CAPI.ovr_Room_UpdateOwner(roomID, userID)) : null;
        ...
        ///
        public static Request<Models.Room> UpdatePrivateRoomJoinPolicy(ulong roomID, RoomJoinPolicy newJoinPolicy) => Core.IsInitialized() ? new Request<Models.Room>(CAPI.ovr_Room_UpdatePrivateRoomJoinPolicy(roomID, newJoinPolicy)) : null;
        ...
        ///
        public static void SetRoomInviteAcceptedNotificationCallback(Message<string>.Callback callback) => Callback.SetNotificationCallback(Message.MessageType.Notification_Room_InviteAccepted, callback);
        ...
        ///
        public static void SetRoomInviteReceivedNotificationCallback(Message<Models.RoomInviteNotification>.Callback callback) => Callback.SetNotificationCallback(Message.MessageType.Notification_Room_InviteReceived, callback);
        /// Indicates that the current room has been updated. Use Message.GetRoom() to
        /// extract the updated room.
        ///
        public static void SetUpdateNotificationCallback(Message<Models.Room>.Callback callback) => Callback.SetNotificationCallback(Message.MessageType.Notification_Room_RoomUpdate, callback);
    }
    ...
    public static partial class Users
    {
        ...
        ///
        public static Request<Models.User> Get(ulong userID) => Core.IsInitialized() ? new Request<Models.User>(CAPI.ovr_User_Get(userID)) : null;

        /// Return an access token for this user, suitable for making REST calls
        /// against graph.oculus.com.
        ///
        public static Request<string> GetAccessToken() => Core.IsInitialized() ? new Request<string>(CAPI.ovr_User_GetAccessToken()) : null;
        ...
        /// NOTE: Users will have a unique ID per application.
        ///
        public static Request<Models.User> GetLoggedInUser() => Core.IsInitialized() ? new Request<Models.User>(CAPI.ovr_User_GetLoggedInUser()) : null;

        /// Retrieve a list of the logged in user's friends.
        ///
        public static Request<Models.UserList> GetLoggedInUserFriends() => Core.IsInitialized() ? new Request<Models.UserList>(CAPI.ovr_User_GetLoggedInUserFriends()) : null;

        /// Retrieve a list of the logged in user's friends and any rooms they might be
        /// in.
        ///
        public static Request<Models.UserAndRoomList> GetLoggedInUserFriendsAndRooms() => Core.IsInitialized() ? new Request<Models.UserAndRoomList>(CAPI.ovr_User_GetLoggedInUserFriendsAndRooms()) : null;
        ...
        ///
        public static Request<Models.UserAndRoomList> GetLoggedInUserRecentlyMetUsersAndRooms(UserOptions userOptions = null) => Core.IsInitialized()
                ? new Request<Models.UserAndRoomList>(CAPI.ovr_User_GetLoggedInUserRecentlyMetUsersAndRooms((IntPtr)userOptions))
                : null;
        ...
        ///
        public static Request<Models.OrgScopedID> GetOrgScopedID(ulong userID) => Core.IsInitialized() ? new Request<Models.OrgScopedID>(CAPI.ovr_User_GetOrgScopedID(userID)) : null;

        /// Returns all accounts belonging to this user. Accounts are the Oculus user
        /// and x-users that are linked to this user.
        ///
        public static Request<Models.SdkAccountList> GetSdkAccounts() => Core.IsInitialized() ? new Request<Models.SdkAccountList>(CAPI.ovr_User_GetSdkAccounts()) : null;
        ...
        ///
        public static Request<Models.UserProof> GetUserProof() => Core.IsInitialized() ? new Request<Models.UserProof>(CAPI.ovr_User_GetUserProof()) : null;

        /// Launch the flow for sending a friend request to a user.
        /// \param userID User ID of user to send a friend request to
        ///
        public static Request<Models.LaunchFriendRequestFlowResult> LaunchFriendRequestFlow(ulong userID) => Core.IsInitialized() ? new Request<Models.LaunchFriendRequestFlowResult>(CAPI.ovr_User_LaunchFriendRequestFlow(userID)) : null;
        ...
        ///
        public static Request LaunchProfile(ulong userID) => Core.IsInitialized() ? new Request(CAPI.ovr_User_LaunchProfile(userID)) : null;
    }
    ...
    public static partial class Voip
    {
        ...
        ///
        public static Request<Models.SystemVoipState> SetSystemVoipSuppressed(bool suppressed) => Core.IsInitialized() ? new Request<Models.SystemVoipState>(CAPI.ovr_Voip_SetSystemVoipSuppressed(suppressed)) : null;
        ...
        ///
        public static void SetVoipConnectRequestCallback(Message<Models.NetworkingPeer>.Callback callback) => Callback.SetNotificationCallback(Message.MessageType.Notification_Voip_ConnectRequest, callback);
        ...
        /// current state.
        ///
        public static void SetVoipStateChangeCallback(Message<Models.NetworkingPeer>.Callback callback) => Callback.SetNotificationCallback(Message.MessageType.Notification_Voip_StateChange, callback);
        ...
        ///
        public static void SetSystemVoipStateNotificationCallback(Message<Models.SystemVoipState>.Callback callback) => Callback.SetNotificationCallback(Message.MessageType.Notification_Voip_SystemVoipState, callback);
    }
    ...
    public static partial class Achievements
    {
        public static Request<Models.AchievementDefinitionList> GetNextAchievementDefinitionListPage(Models.AchievementDefinitionList list)
        {
            ...
            return Core.IsInitialized()
                ? new Request<Models.AchievementDefinitionList>(CAPI.ovr_HTTP_GetWithMessageType(list.NextUrl, (int)Message.MessageType.Achievements_GetNextAchievementDefinitionArrayPage))
                : null;
        }
        ...
        public static Request<Models.AchievementProgressList> GetNextAchievementProgressListPage(Models.AchievementProgressList list)
        {
            ...
            return Core.IsInitialized()
                ? new Request<Models.AchievementProgressList>(CAPI.ovr_HTTP_GetWithMessageType(list.NextUrl, (int)Message.MessageType.Achievements_GetNextAchievementProgressArrayPage))
                : null;
        }
    }
    ...
    public static partial class CloudStorage
    {
        public static Request<Models.CloudStorageMetadataList> GetNextCloudStorageMetadataListPage(Models.CloudStorageMetadataList list)
        {
            ...
            return Core.IsInitialized()
                ? new Request<Models.CloudStorageMetadataList>(CAPI.ovr_HTTP_GetWithMessageType(list.NextUrl, (int)Message.MessageType.CloudStorage_GetNextCloudStorageMetadataArrayPage))
                : null;
        }
    }
    ...
    public static partial class IAP
    {
        public static Request<Models.ProductList> GetNextProductListPage(Models.ProductList list)
        {
            ...
            return Core.IsInitialized()
                ? new Request<Models.ProductList>(CAPI.ovr_HTTP_GetWithMessageType(list.NextUrl, (int)Message.MessageType.IAP_GetNextProductArrayPage))
                : null;
        }
        ...
        public static Request<Models.PurchaseList> GetNextPurchaseListPage(Models.PurchaseList list)
        {
            ...
            return Core.IsInitialized()
                ? new Request<Models.PurchaseList>(CAPI.ovr_HTTP_GetWithMessageType(list.NextUrl, (int)Message.MessageType.IAP_GetNextPurchaseArrayPage))
                : null;
        }
    }
    ...
    public static partial class Notifications
    {
        public static Request<Models.RoomInviteNotificationList> GetNextRoomInviteNotificationListPage(Models.RoomInviteNotificationList list)
        {
            ...
            return Core.IsInitialized()
                ? new Request<Models.RoomInviteNotificationList>(CAPI.ovr_HTTP_GetWithMessageType(list.NextUrl, (int)Message.MessageType.Notification_GetNextRoomInviteNotificationArrayPage))
                : null;
        }
    }
    ...
    public static partial class Rooms
    {
        public static Request<Models.RoomList> GetNextRoomListPage(Models.RoomList list)
        {
            ...
            return Core.IsInitialized()
                ? new Request<Models.RoomList>(CAPI.ovr_HTTP_GetWithMessageType(list.NextUrl, (int)Message.MessageType.Room_GetNextRoomArrayPage))
                : null;
        }
    }
    ...
    public static partial class Users
    {
        public static Request<Models.UserAndRoomList> GetNextUserAndRoomListPage(Models.UserAndRoomList list)
        {
            ...
            return Core.IsInitialized()
                ? new Request<Models.UserAndRoomList>(CAPI.ovr_HTTP_GetWithMessageType(list.NextUrl, (int)Message.MessageType.User_GetNextUserAndRoomArrayPage))
                : null;
        }
        ...
        public static Request<Models.UserList> GetNextUserListPage(Models.UserList list)
        {
            ...
            return Core.IsInitialized()
                ? new Request<Models.UserList>(CAPI.ovr_HTTP_GetWithMessageType(list.NextUrl, (int)Message.MessageType.User_GetNextUserArrayPage))
                : null;
        }
    }
}

...
public class OVRControllerHelper : MonoBehaviour
{
    ...
    ControllerType activeControllerType = ControllerType.Rift;

    bool m_prevControllerConnected = false;
    bool m_prevControllerConnectedCached = false;
    ...
    void Start()
    {
        ...
        switch (headset)
        {
            case OVRPlugin.SystemHeadset.Oculus_Go: activeControllerType = ControllerType.Go; break;
            case OVRPlugin.SystemHeadset.Oculus_Quest: activeControllerType = ControllerType.QuestAndRiftS; break;
            case OVRPlugin.SystemHeadset.Rift_CV1: activeControllerType = ControllerType.Rift; break;
            case OVRPlugin.SystemHeadset.Rift_S: activeControllerType = ControllerType.QuestAndRiftS; break;
            case OVRPlugin.SystemHeadset.GearVR_R320:
            case OVRPlugin.SystemHeadset.GearVR_R321:
            case OVRPlugin.SystemHeadset.GearVR_R322:
            case OVRPlugin.SystemHeadset.GearVR_R323:
            case OVRPlugin.SystemHeadset.GearVR_R324:
            case OVRPlugin.SystemHeadset.GearVR_R325: activeControllerType = ControllerType.GearVR; break;
            default: activeControllerType = Application.isEditor || Application.platform != RuntimePlatform.Android ? ControllerType.Rift : ControllerType.GearVR; break;
        }
        ...
        {
            if (m_controller == OVRInput.Controller.LTrackedRemote) m_controller = OVRInput.Controller.LTouch;
            else if (m_controller == OVRInput.Controller.RTrackedRemote) m_controller = OVRInput.Controller.RTouch;
        }
        else
        {
            if (m_controller == OVRInput.Controller.LTouch) m_controller = OVRInput.Controller.LTrackedRemote;
            else if (m_controller == OVRInput.Controller.RTouch) m_controller = OVRInput.Controller.RTrackedRemote;
        }
    }

    void Update()
    {
        var controllerConnected = OVRInput.IsControllerConnected(m_controller);

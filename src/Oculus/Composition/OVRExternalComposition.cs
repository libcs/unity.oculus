...
public class OVRExternalComposition : OVRComposition
{
        ...
        : base(parentObject, mainCamera)
    {
        ...
        backgroundCameraGameObject = new GameObject { name = "MRBackgroundCamera" };
        ...
        foregroundCameraGameObject = new GameObject { name = "MRForgroundCamera" };
    ...
    public override void Update(Camera mainCamera)
    {
        ...
        var externalCameraToHeadXZ = mainCamera.transform.position - foregroundCamera.transform.position;
